...
Charge de préférence le classeur v6 ; sinon v5 ; sinon v4. Écrit la copie de test (ex. v6_TEST.xlsx).
"""
...
from vae_report_style import AMBER_LT_XL, GREEN_LT_XL, RED_LT_XL
...
V6 = Path("/Users/imran/Downloads/VAE_tout_inclus_01_05_2026_Final1_v6.xlsx")
WORKBOOK_DEFAULT = V6 if V6.exists() else (V5 if V5.exists() else V4)
OUT = Path("/Users/imran/Downloads/VAE_tout_inclus_01_05_2026_Final1_v6_TEST.xlsx")
...
FILL_GREEN = PatternFill("solid", fgColor=GREEN_LT_XL)
FILL_ORANGE = PatternFill("solid", fgColor=AMBER_LT_XL)
FILL_RED = PatternFill("solid", fgColor=RED_LT_XL)
